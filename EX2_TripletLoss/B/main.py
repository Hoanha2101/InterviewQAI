...
def triplet_loss_extended(anchor, positives, negatives, alpha=0.3):
    """
    Compute the Triplet Loss for multiple positives and negatives.

    Arguments:
        anchor: numpy array of shape (1, n), embeddings for the anchor images
        positives: numpy array of shape (1, k, n), embeddings for the positive images
        negatives: numpy array of shape (1, l, n), embeddings for the negative images
        alpha: margin
